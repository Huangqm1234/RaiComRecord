...
firstState = "Start",
 ...
 ["Start"] = {
 	...
 	Receiver   = task.GotoPos("Receiver",150,0,Receiverdir2Balldir),
...
["PassBall_L"] = {
	...
	Receiver = task.GotoPos("Receiver",150,-50,Receiverdir2Balldir),
...
["Receive"] = {
	switch = function()
		if  CBall2RoleDist("Receiver") < 50 and Cbuf_cnt(true,60) then
			return "Shoot"
		end
	end,
