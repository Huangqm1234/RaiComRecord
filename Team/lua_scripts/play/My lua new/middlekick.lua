...
["Start"] = {
	switch = function()
		if CRole2TargetDist("Kicker") < 20 and Cbuf_cnt(true,30) then
			return "PassBall"
		end
	end,
	Kicker   = task.GotoPos("Kicker",50,100,Kickerdir2Balldir),
...
["PassBall"] = {
	...
	Receiver = task.ReceiverTask("mypassballpower15"),
	Goalie   = task.Goalie()
},

["Receive"] = {
	switch = function()
		if  CBall2RoleDist("Kicker") < 50 and Cbuf_cnt(true,40) then
			return "Shoot"
		end
	end,
